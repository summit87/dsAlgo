...
public class Bitwise1 {
    ...
    public static void rightShift(){
        /**
         * Similarly , for the right shift , we will be divind the number with 2^k
         * K : which represent number bit we are shifting to the right for give number
         * 
         * e.g we are shifting 2 bit of the right of number 5
         * 5 / 2^2 :  1 
         * representation purpose , if we wanted to do k shift for give number n to the right
         * n, n >> k
         */
    ...
    /**
     * How to get the number - 1 , i.e 
     * if number is n = 4, then how we will get 4-1 => 3 using bitwise
     * bitwise representational of number 4 => 0100 
     * Lets do the reverse all the bit of the rightmost once 
     * steps :
     *      1.   4 => 0100
     *      2.   rerse all the bit of the rightmost one's including the rightmost once , i.e 0100 => 0011 ,
     *      3.   0011 => 3
     * 
     */
...
/***********************************************************************************
 *                TO FIND WHEATHER AS NUMBER IS POWER OF TWO OR NOT                *
 *             WE NEED TO DO DO BELOW STEP. LET SAY GIVEN NUMBER IS N              *
 *                  1. THEN GET THE GIVE NUMBER AND DO ,  X = N-1                  *
 *                            2. THEN DO THE (N & X) ,                             *
 *           IF ANY NUMBER IS POWER OF TWO THEN ONLY ONE BIT WILL BE SET           *
 * IF NUMBER HAVING MORE THAN ONE BIT SET , THEN THAT NUMBER IS NOT A POWER OF TWO *
 ***********************************************************************************/
     ...
     public static boolean checkIfIthBitSetOrNot(int num,int ith){
        /**
         * To check if ith bit for any given number is set , we need to peform below steps , let say number is N
         * 
